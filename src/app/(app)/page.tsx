    ...
    <>
      <main className="flex-grow flex flex-col items-center justify-center h-[60vh] max-sm:h-[42vh]">
        <section className="text-center flex flex-col items-center justify-end">
          <h1
            className={`text-3xl md:text-7xl font-bold ${bricolage_grotesque}`}
          >
          ...
          <p
            className={`mt-5 text-lg max-sm:text-xs text-gray-500 dark:text-gray-300 text-center tracking-normal leading-6 ${inter}`}
          >
            AnonyGram - Where your identity remains a secret.
          </p>
      ...
      <div className="space-y-4 mt-32 max-sm:mt-20 pb-10 max-sm:pb-20">
        <h2
          className={`text-center text-2xl md:text-5xl font-bold ${bricolage_grotesque}`}
        >
